...
export type PostGroupConnection = {
   __typename?: 'PostGroupConnection',
  totalCount: Scalars['Int'],
  edges: Array<PostEdge>,
  nodes: Array<Post>,
  pageInfo: PageInfo,
...
export enum SitePageFieldsEnum {
  ...
  context___previous = 'context___previous',
...
export type LoadPostsQueryVariables = {
  limit: Scalars['Int']
};
...
export type LoadFilteredPostsQueryVariables = {
  limit: Scalars['Int']
};


export type LoadFilteredPostsQuery = (
  { __typename?: 'Query' }
  & { allPost: (
    { __typename?: 'PostConnection' }
    & { edges: Array<(
  ...
  & { site: Maybe<(
    ...
    & { siteMetadata: Maybe<(
      ...
      & { author: Maybe<(
        ...
        & { contacts: Maybe<(
          { __typename?: 'SiteSiteMetadataAuthorContacts' }
          & Pick<SiteSiteMetadataAuthorContacts, 'facebook' | 'linkedin' | 'github' | 'twitter' | 'telegram' | 'instagram' | 'email' | 'rss' | 'vkontakte' | 'line' | 'gitlab' | 'weibo' | 'codepen' | 'youtube'>
        )> }
      )>, menu: Maybe<Array<Maybe<(
        { __typename?: 'SiteSiteMetadataMenu' }
        & Pick<SiteSiteMetadataMenu, 'label' | 'path'>
      )>>> }
    )> }
  )> }
);
...
export type PostListQuery = (
  ...
  & { posts: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Post' }
        & Pick<Post, 'id' | 'slug' | 'date' | 'title' | 'excerpt'>
      ) }
    )> }
  ) }
);
